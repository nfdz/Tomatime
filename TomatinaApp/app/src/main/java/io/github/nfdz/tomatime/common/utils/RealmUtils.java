...
import io.github.nfdz.tomatime.BuildConfig;
...
public class RealmUtils {
    ...
    private static final String DB_NAME = "tomatime.realm";
    ...
    public static void savePomodoroInfo(Realm realm,
        ...
        if (TextUtils.isEmpty(title)) {
            title = TomatimeApp.INSTANCE.getString(R.string.info_no_title_value);
        }
